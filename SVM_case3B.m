function [trainedClassifier, validationAccuracy, F1, AUC,XROC, YROC] = SVM_case3B(trainingData, responseData)
...
%
%  Input:
%      trainingData: Feature matrix N_aug x 5, where N is the number of rows 
%      of the augmented feature matrix for the case of 5 storeys.
...
classificationSVM = fitcsvm(...
    ...
    'PolynomialOrder', [], ...
    'KernelScale', 1, ...
    'BoxConstraint', 0.452937179068568, ...
    'Standardize', false, ...
    'ClassNames', [0; 1]);
