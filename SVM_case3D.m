function [trainedClassifier, validationAccuracy, F1, AUC,XROC, YROC] = SVM_case3D(trainingData, responseData)
...
%
%  Input:
%      trainingData: Feature matrix N_aug x 7, where N is the number of rows 
%      of the augmented feature matrix for the case of 7 storeys.
...
classificationSVM = fitcsvm(...
    ...
    'PolynomialOrder', [], ...
    'KernelScale', 3.017032589567988, ...
    'BoxConstraint', 0.002014219156814813, ...
    'Standardize', true, ...
    'ClassNames', [0; 1]);
