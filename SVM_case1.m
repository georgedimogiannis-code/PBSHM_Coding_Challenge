function [trainedClassifier, validationAccuracy, F1, AUC,XROC, YROC] = SVM_case1(trainingData, responseData)
...
%
%  Input:
%      trainingData: Feature matrix N x MIN_DOF, where N=30 the members 
%      of the population employed (15 Healthy/15 Damaged) and MIN_DOF=4.
...
classificationSVM = fitcsvm(...
    ...
    'PolynomialOrder', [], ...
    'KernelScale', 26.83089960877079, ...
    'BoxConstraint', 0.001492555992505176, ...
    'Standardize', false, ...
    'ClassNames', [0; 1]);
