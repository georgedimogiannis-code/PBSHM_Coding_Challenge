function [trainedClassifier, validationAccuracy, F1, AUC,XROC, YROC] = SVM_case3A(trainingData, responseData)
...
%
%  Input:
%      trainingData: Feature matrix N_aug x 4, where N is the number of rows 
%      of the augmented feature matrix for the case of 4 storeys.
...
classificationSVM = fitcsvm(...
    ...
    'PolynomialOrder', [], ...
    'KernelScale', 1.241528404080678, ...
    'BoxConstraint', 0.001137650356863668, ...
    'Standardize', true, ...
    'ClassNames', [0; 1]);
