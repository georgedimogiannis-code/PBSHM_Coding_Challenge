function [trainedClassifier, validationAccuracy, F1, AUC,XROC, YROC] = SVM_case3E(trainingData, responseData)
...
%
%  Input:
%      trainingData: Feature matrix N_aug x 8, where N is the number of rows 
%      of the augmented feature matrix for the case of 8 storeys.
...
classificationSVM = fitcsvm(...
    ...
    'PolynomialOrder', [], ...
    'KernelScale', 3.30855767459009, ...
    'BoxConstraint', 6.424721897539107, ...
    'Standardize', false, ...
    'ClassNames', [0; 1]);
